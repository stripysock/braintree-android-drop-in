    ...
    private void enterState(int state) {
        switch(state) {
            ...
            case DETAILS_ENTRY:
                ...
                mEditCardView.setCardType(mAddCardView.getCardType(), mDropInRequest.getAmount(), mDropInRequest.getVisaSurcharge(), mDropInRequest.getMastercardSurcharge(), mDropInRequest.getAmexSurcharge());
